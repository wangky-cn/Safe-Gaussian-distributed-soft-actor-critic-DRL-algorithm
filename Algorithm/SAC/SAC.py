...
class SAC(object):
    def __init__(self, state_dim, action_dim, max_action, device, actor_hidden_width = [500, 400, 300], critic_hidden_width = [500, 400, 300],
                 batch_size = 120, GAMMA = 0.99, TAU = 0.005, lr = 1e-4, clr = 1e-4, alr = 1e-4, policy_freq = 2, adaptive_alpha = True):
        self.device = device
        ...
        self.critic = Critic(self.state_dim, self.action_dim, self.critic_hidden_width).to(self.device)
