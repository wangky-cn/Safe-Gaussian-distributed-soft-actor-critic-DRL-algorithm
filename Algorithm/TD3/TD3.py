...
class TD3(object):
    def __init__(
            ...
            actor_lr=5e-5,
            critic_lr=5e-5,
            actor_hidden_width=[500, 400, 300],
            critic_hidden_width=[500, 400, 300],
    ):
        self.device = device
        ...
        self.actor = Actor(self.state_dim, self.action_dim, self.actor_hidden_width, max_action).to(self.device)
...
if __name__ == '__main__':
    ...
    for i in range(len(seed_list)):
        ...
        trainer = Trainer(env, agent, replay_buffer, max_train_steps, random_steps, device, expl_noise, summary_writer,
